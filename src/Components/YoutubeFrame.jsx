...
//       <div className="movieshead-yf d-flex">
//                 <h4><b>IN THEATER</b></h4>
//                 <a href="/intheater"><b>VIEW ALL</b> <FaArrowRight /></a>
//               </div>
...
//   // Auto-play next video every 10s
//   useEffect(() => {
//     if (!autoPlayStarted.current) {
//       autoPlayStarted.current = true;
//       return;
...
//                 <p className="thumb-duration">{video.duration}</p>
//               </div>
//             </div>
//           ))}
//         </div>
